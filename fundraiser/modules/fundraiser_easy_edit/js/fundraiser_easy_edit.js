 ...
 */
      ...
      */
      ...
      /*
       * Custom Text Component Model class
       */
      var TextComponentModel = Backbone.Model.extend({
  	    // Default values
  	    defaults: {
    	  cid: '',
    	  pid: 0,
      ...
      /*
       * Custom Text Component View Class
       */
      var TextComponentView = Backbone.View.extend({
        tagName: 'div', // required, but defaults to 'div' if not set
        className: 'control-group sortable', 
        id: '', // optional      
      });

      /*
       * Create BlockUI function(vars)
       */
        ...
        $.blockUI({ 
          ...
          onBlock: function(){
            ...
            $('form#form-textfield').submit(function(e){
                ...
                var component = new TextComponentModel({type: input_type, 
