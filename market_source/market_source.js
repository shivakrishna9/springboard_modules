(function ($) {
  ...
  Drupal.behaviors.marketSourceInit = {
    attach: function (context, settings) {
      $('body:not(.marketsource-processed)', context).each(function(i){
        if (typeof settings.market_source === 'undefined' ||
          typeof settings.market_source.qs_keys === 'undefined') {
            return;
        }
         ...
         */
        var qs_keys = settings.market_source.qs_keys;
  ...
  Drupal.behaviors.marketSourceFormPopulate = {
    attach: function (context, settings) {
      if (typeof settings.market_source === 'undefined' ||
        typeof settings.market_source.form_keys === 'undefined' ||
        typeof settings.market_source.qs_keys === 'undefined') {
          return;
      }
      ...
      var maxlength = 255;
      if (typeof settings.market_source.maxlength !== 'undefined') {
        maxlength = settings.market_source.maxlength;
      }

      var qs_keys = settings.market_source.qs_keys;
      // Iterate across all webforms on the page.
      for (var form_id in settings.market_source.form_keys) {
        // Iterate across all form keys in this webform.
        var form_keys = settings.market_source.form_keys[form_id];
